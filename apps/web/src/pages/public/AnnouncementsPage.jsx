          ...
          <>
            ...
            {featured && (
              <div className="bg-surface rounded-xl shadow-card p-6 mb-8 border border-border">
                ...
                <Link to={`/announcements/${featured.id}`} className="block group w-fit">
                  <h2 className="text-lg font-bold text-content leading-snug mb-3 group-hover:text-primary transition-colors">
                    {featured.title}
                  </h2>
                </Link>
