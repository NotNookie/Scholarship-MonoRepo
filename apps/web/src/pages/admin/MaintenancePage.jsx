...
const CARDS = [
  ...
  {
    Icon: CalendarRange,
    title: 'Application Cycles & Documents',
    description: 'Schedule opening dates, deadlines, and review windows — and maintain the required-document checklist for each cycle.',
