...
export const APPLICATION_STATUS = {
  ...
  submitted:  { label: 'Under Review', Icon: Clock,         color: 'text-primary',       bg: 'bg-primary-light',   border: 'border-primary/20' },
  incomplete: { label: 'Incomplete',   Icon: AlertTriangle, color: 'text-on-secondary',  bg: 'bg-secondary-light', border: 'border-secondary/30' },
