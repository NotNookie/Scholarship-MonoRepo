...
export const APPLICATION_STATUS = {
  ...
  submitted:    { label: 'Pending Review', Icon: Clock,         color: 'text-on-secondary',  bg: 'bg-secondary-light', border: 'border-secondary/30' },
  under_review: { label: 'Pending Review', Icon: Clock,         color: 'text-on-secondary',  bg: 'bg-secondary-light', border: 'border-secondary/30' },
